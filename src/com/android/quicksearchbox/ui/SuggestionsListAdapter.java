...
public class SuggestionsListAdapter extends SuggestionsAdapterBase<ListAdapter> {
    ...
    public SuggestionsListAdapter(Context context, SuggestionViewFactory viewFactory, SearchSectionIndexer searchSectionIndexer) {
        super(context, viewFactory, searchSectionIndexer);
