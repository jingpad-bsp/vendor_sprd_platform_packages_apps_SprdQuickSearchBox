...
public class DelayingSuggestionsAdapter<A> implements SuggestionsAdapter<A> {
    ...
    public DelayingSuggestionsAdapter(Context context, SuggestionsAdapterBase<A> delayed) {
    ...
    public void setListView(ListView listView){
        mDelayedAdapter.setListView(listView);
    }

    @Override
    public int getPinnedHeaderState(int position) {
        return mDelayedAdapter.getPinnedHeaderState(position);
    }

    @Override
    public void configurePinnedHeader(View header, int position, int alpha) {
        mDelayedAdapter.configurePinnedHeader(header, position, alpha);
    }
}
