...
public class ApplicationsProvider extends ContentProvider {
    ...
    private BroadcastReceiver mLocaleChangeReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_LOCALE_CHANGED.equals(action)) {
                ...
                // SPRD: Add 20140331 Spreadst of bug291136, application cannot be
                // searched after locale change
    ...
    private void createDatabase() {
        ...
        mDb.execSQL("CREATE TRIGGER applicationsLookup_update UPDATE OF " + NAME + " ON " +
                ...
                "INSERT INTO applicationsLookup(token, source, token_index) VALUES (new." + NAME + ", new." + _ID + ", ' ');" +
                "END");
    ...
    private Cursor searchApplications(String query, String[] projectionIn,
        ...
        String orderBy = null;
        if (!zeroQuery) {
            /* UNISOC: Modify for bug320517,1201756 @{ */
            /*if (DatabaseUtils.getHexCollationKey(query).length() != 2) {
    ...
    private String buildTokenFilter(String filterParam) {
        ...
        /* Modify 20130201 Spreadst of 122885,can not search start */
//        DatabaseUtils.appendEscapedSQLString(filter,
//                DatabaseUtils.getHexCollationKey(filterParam) + "*");
        DatabaseUtils.appendEscapedSQLString(filter,
                "*" + DatabaseUtils.getHexCollationKey(filterParam) + "*");
        /* Modify 20130201 Spreadst of 122885,can not search end */
    ...
    private synchronized void updateApplicationsList(String packageName) {
        ...
        //int lastResumeTimeCol = inserter.getColumnIndex(LAST_RESUME_TIME); // UNISOC: Modify for bug1210540
