...
public class Util {
    ...
    private final static String KEY_TEST_ILLEGAL = "key_test_illegal";
    /* @} */
    ...
    public static boolean checkIntent(Intent intent) {
        ...
        try {
            intent.getStringExtra(KEY_TEST_ILLEGAL);
        } catch (RuntimeException e) {
            Log.e("SprdQuickSearchBox", "This intent may come from malware!!!intent = " + intent, e);
            illegal = true;
        }
    ...
    public static final String FILE_NAME_BLUR_BG = "blur_bg.png";
}
