...
/* Modify 20121214 Spreadst of 104320,can't dispaly all serarch content end */
    ...
    public Drawable getSourceIcon() {
        ...
        return mSourceIcon.newDrawable(); // UNISOC: Modify for bug1207580
    }
    ...
    private Cursor getSuggestions(Context context, SearchableInfo searchable, String query,
            int queryLimit) {
        /* UNISOC: Modify for bug1149950,1182389,1202626, search music from mediaprovider @{ */
        String authority = searchable.getSuggestAuthority();
        if ("media".equals(authority)) {
            String[] searchCols = new String[] {
                    android.provider.BaseColumns._ID,
                    MediaStore.Audio.Media.MIME_TYPE,
                    "title AS " + SearchManager.SUGGEST_COLUMN_TEXT_1,
                    "title AS " + SearchManager.SUGGEST_COLUMN_QUERY,
                    "artist AS " + SearchManager.SUGGEST_COLUMN_TEXT_2,
            ...
            Cursor mediaCursor = context.getContentResolver().query(searchUri, searchCols, where.toString(), args, null);
            mediaCursor = matrixCursorFromCursor(context, mediaCursor);
            return mediaCursor;
        }
        /* @} */
        ...
        if (base == null || !SecurityAccessContacts.querySuggetsUri(base)) {
            return null;
        }
        /* @} */
    ...
    /* UNISOC: Modify for bug1202626,1218417 @{ */
    private static MatrixCursor matrixCursorFromCursor(Context context, Cursor cursor) {
        if (cursor == null) {
            return null;
        }
        ...
        String mimetype,title,artist,album;
